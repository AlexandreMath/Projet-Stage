<form id="form" class="form-horizontal valid-me" action="nl_etape1.php" method="post" role="form">
    ...
    <div class="form-group">
      ...
      <div class="col-xs-4">
        <input type="password" class="form-control" name="password" id="password" data-validetta="required"  value="<?php echo $_POST['password']; ?>" >
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-xs-4">
        <input type="password" class="form-control" id="confpassword" name="confpassword" data-validetta="required,equal[password]"   value="<?php echo $_POST['confpassword']; ?>" >
      </div>
    </div>
  ...
  <div class="form-group">
    ...
    <div class="col-xs-1">
      <button type="button" tabindex="-1" class="toolbut" data-toggle="tooltip" data-placement="top" title="Geef de voornamen en namen (in die volgorde aub, eerst de voornaam, dan de naam en niet andersom) van de bedrijfsleider(s) en/of van de eventuele medewerkers. Met een koma tussen elke persoon, behalve tussen de voorlaatste en de laatste : gebruik dan een &. Gebruik hoofdletters en kleine letters waar nodig. Vergeet ook niet de vereiste accenten en koppeltekens te plaatsen."><img src="../img/question.png" alt="info"></button>
    </div>
    <div class="col-xs-4">
 ...
 <?php /*
  ...
  <div class="form-group">
                                       ...
                                       <div class="col-xs-4">  
                                        ...
                                        <input type="text" class="form-control" id="us3-address" data-validetta="required" <?php if($_SESSION['loc']){echo 'value="'.addslashes($_SESSION['loc']).'"';}?>/>
								  ...
								  <script>
                                      ...
                                      $('#us3').locationpicker({
                                        radius: 0,
  										  zoom: 12,  
                                          location: {latitude: <?php echo $lat == '' ? '51.0184461' : $lat ?>, longitude:  <?php echo $lg == '' ? '3.7741918' : $lg ?>}, 
                                          inputBinding: {  
 ...
 <div class="form-group">
    ...
    <div class="col-xs-4">
      <p class="help-block">0476/753.933</p>
    </div>
 </div>
 ...
 <div class="form-group">
    ...
    <div class="col-xs-4">
      <p class="help-block">0488/456.789</p>
    </div>
 </div>*/ ?>
 ...
 <div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="col-xs-4">
      <input type="text" class="form-control" id="nomuser" name="nomuser" value="<?php echo $_POST['nomuser'];?>" data-validetta="required" >
    </div>
 ...
 <div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="col-xs-1">
      <button type="button" tabindex="-1" class="toolbut" data-toggle="tooltip" data-placement="top" title="Geef hier de officiële benaming van de firma in die onze factuur zal ontvangen."><img src="../img/question.png" alt="info"></button>
    </div>
    <div class="col-xs-4">
 ...
 <div class="form-group">
    ...
    <div class="col-xs-4">
      <select class="form-control" name="facturation_juridique" id="facturation_juridique">
      		<option>-</option>
            <option <?php if($_POST['facturation_juridique'] =='Natuurlijke persoon - Eenmanszaak') { echo 'selected'; } ?> value="Natuurlijke persoon - Eenmanszaak">Natuurlijke persoon - Eenmanszaak</option>
            <option <?php if($_POST['facturation_juridique'] =='Nameloze venootschap (NV)') { echo 'selected'; } ?> value="Nameloze venootschap (NV)">Nameloze venootschap (NV)</option>
            <option <?php if($_POST['facturation_juridique'] =='Besloten vennootschap met beperkte aansprakelijkheid (BVBA)') { echo 'selected'; } ?> value="Besloten vennootschap met beperkte aansprakelijkheid (BVBA)">Besloten vennootschap met beperkte aansprakelijkheid (BVBA)</option>
            <option <?php if($_POST['facturation_juridique'] =='Starter - Besloten vennootschap met beperkte aansprakelijkheid (S-BVBA)') { echo 'selected'; } ?> value="Starter - Besloten vennootschap met beperkte aansprakelijkheid (S-BVBA)">Starter - Besloten vennootschap met beperkte aansprakelijkheid (S-BVBA)</option>
            <option <?php if($_POST['facturation_juridique'] =='Coöperatieve vennootschap met onbeperkte aansprakelijkheid (CVOA)') { echo 'selected'; } ?> value="Coöperatieve vennootschap met onbeperkte aansprakelijkheid (CVOA)">Coöperatieve vennootschap met onbeperkte aansprakelijkheid (CVOA)</option>
            <option <?php if($_POST['facturation_juridique'] =='Coöperatieve vennootschap met beperkte aansprakelijkheid (CVBA)') { echo 'selected'; } ?> value="Coöperatieve vennootschap met beperkte aansprakelijkheid (CVBA)">Coöperatieve vennootschap met beperkte aansprakelijkheid (CVBA)</option>
            <option <?php if($_POST['facturation_juridique'] =='Commanditaire venootschap op aandelen') { echo 'selected'; } ?> value="Commanditaire venootschap op aandelen">Commanditaire venootschap op aandelen</option>
            <option <?php if($_POST['facturation_juridique'] =='Gewone commanditaire vennootschap (Comm.V.)') { echo 'selected'; } ?> value="Gewone commanditaire vennootschap (Comm.V.)">Gewone commanditaire vennootschap (Comm.V.)</option>
            <option <?php if($_POST['facturation_juridique'] =='Vennootschap onder firma (VOF)') { echo 'selected'; } ?> value="Vennootschap onder firma (VOF)">Vennootschap onder firma (VOF)</option>
  ...
  <div class="form-group">  
   <div class="col-sm-3">
      <input type="checkbox" <?php if($_POST['conditions'] == 'ja' || $_POST['conditions'] == 'oui') { echo 'checked = "checked"'; } ?> id="conditions" name="conditions" value="ja" data-validetta="required" >
    </div>   
  ...
  <div class="form-group">
    <div class="col-sm-3">
      <input type="checkbox" <?php if($_POST['confirmation'] == 'ja' || $_POST['confirmation'] == 'oui') { echo 'checked = "checked"'; } ?> id="confirmation" name="confirmation" value="ja" data-validetta="required" >
    </div>    
 ...
 <div class="form-group">
            <label for="statut" class="col-xs-4 control-label">Copieer de captcha</label>
            <div class="col-xs-6">                
